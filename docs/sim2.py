...
ALPHA       = 0.20    # EMA smoothing: 0.1=slow .. 0.5=fast
CLAMP       = 0.20    # max allowed deviation per step: 0.20 = ±20%
...
# Alarm parameters
P1 = 0.12   # magnitude weight: how strongly a single spike contributes
P2 = 0.30   # decay speed: larger = score drops faster when rate returns to EMA
...
SCENARIO_A = [
    100, 98, 102, 97, 103, 99, 101, 100, 98, 102,
    100, 99, 101, 100, 102, 98, 100, 101, 99, 100,
    100, 98, 102, 97, 103, 99, 101, 100, 98, 102,
    100, 99, 101, 100, 102, 98, 100, 101, 99, 100,
    100, 98, 102, 97, 103, 99, 101, 100, 98, 102,
]
